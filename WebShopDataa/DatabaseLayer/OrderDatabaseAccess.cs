...
namespace WebShopData.DatabaseLayer
{
    public class OrderDatabaseAccess : IOrderAccess
    {
...

        {
            ...
            //
            string insertString = "insert into [order](customerID, paymentType, notes) OUTPUT INSERTED.ID  values" +
                "(@customerID, @paymentType, @notes)";
            ...
            using (SqlCommand CreateCommand = new SqlCommand(insertString, con))
            {
                ...
                SqlParameter notesParam = new("@notes", aOrder.notes);
                CreateCommand.Parameters.Add(notesParam);
                //
                con.Open();
                //
        ...
        public List<Order> GetOrderAll()
        {
            ...
            Order readOrder;
            //
            string queryString = "select ID, orderDate, customerID, paymentType, notes from [order]";
            using (SqlConnection con = new SqlConnection(_connectionString))
        ...
        private Order GetOrderFromReader(SqlDataReader orderReader)
        {
            ...
            string tempPaymentType, tempNotes;
            double tempAmount;
            ...
            tempPaymentType = orderReader.GetString(orderReader.GetOrdinal("paymentType"));
            tempNotes = orderReader.GetString(orderReader.GetOrdinal("notes"));
            foundOrder = new Order(tempId, tempOrderDate, tempCustomerId,
                tempPaymentType, tempNotes);
